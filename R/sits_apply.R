...
#' all pixels in the window are \code{NA}. Also, when the kernel slides
#' in the border of an input image, only those cells of the kernel
#' intersecting the image is considered by kernel functions.
#'
#' Kernel functions
#'
