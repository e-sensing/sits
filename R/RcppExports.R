...
C_as_array_inplace <- function(x, dim) {
    .Call(`_sits_C_as_array_inplace`, x, dim)
}
...
C_normalize_data_inplace <- function(data, min, max) {
    .Call(`_sits_C_normalize_data_inplace`, data, min, max)
}
