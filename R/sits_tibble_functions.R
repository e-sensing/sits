...
#' @param ref_start_date        Reference starting date
#' @param ref_end_date          Reference end date
...
#'
#' @export
sits_match_dates <- function (timeline, ref_start_date, ref_end_date, interval = "12 month"){
    ...
    ensurer::ensure_that(start_date, .sits_is_valid_start_date(., timeline),
                         err_desc = ".sits_match_date: expected start date in not inside timeline of observations")
    ...
    ensurer::ensure_that(end_date, .sits_is_valid_end_date(., timeline),
                         err_desc = ".sits_match_date: expected end date in not inside timeline of observations")
