...
.sits_brewer_rgb <- tibble::lst(
    "Spectral" = tibble::lst(
        ...
        "4" = tibble::lst(
            grDevices::rgb(215 / 255, 25 / 255, 28 / 255),
        ...
        "10" = tibble::lst(
            grDevices::rgb(158 / 255, 1 / 255, 66 / 255),
            grDevices::rgb(213 / 255, 62 / 255, 79 / 255),
            grDevices::rgb(244 / 255, 109 / 255, 67 / 255),
            grDevices::rgb(253 / 255, 174 / 255, 97 / 255),
            grDevices::rgb(254 / 255, 224 / 255, 139 / 255),
    ...
    "RdYlGn" = tibble::lst(
        ...
        "10" = tibble::lst(
            grDevices::rgb(165 / 255, 0 / 255, 38 / 255),
            grDevices::rgb(215 / 255, 48 / 255, 39 / 255),
            grDevices::rgb(244 / 255, 109 / 255, 67 / 255),
            grDevices::rgb(253 / 255, 174 / 255, 97 / 255),
            grDevices::rgb(254 / 255, 224 / 255, 139 / 255),
    ...
    "RdBu" = tibble::lst(
        ...
        "4" = tibble::lst(
            grDevices::rgb(202 / 255, 0 / 255, 32 / 255),
    ...
    "PiYG" = tibble::lst(
        ...
        "4" = tibble::lst(
            grDevices::rgb(208 / 255, 28 / 255, 139 / 255),
        ...
        "10" = tibble::lst(
            grDevices::rgb(142 / 255, 1 / 255, 82 / 255),
            grDevices::rgb(197 / 255, 27 / 255, 125 / 255),
            grDevices::rgb(222 / 255, 119 / 255, 174 / 255),
            grDevices::rgb(241 / 255, 182 / 255, 218 / 255),
            grDevices::rgb(253 / 255, 224 / 255, 239 / 255),
    ...
    "PRGn" = tibble::lst(
        ...
        "4" = tibble::lst(
            grDevices::rgb(123 / 255, 50 / 255, 148 / 255),
        ...
        "10" = tibble::lst(
            grDevices::rgb(64 / 255, 0 / 255, 75 / 255),
            grDevices::rgb(118 / 255, 42 / 255, 131 / 255),
            grDevices::rgb(153 / 255, 112 / 255, 171 / 255),
            grDevices::rgb(194 / 255, 165 / 255, 207 / 255),
            grDevices::rgb(231 / 255, 212 / 255, 232 / 255),
    ...
    "BrBG" = tibble::lst(
        ...
        "4" = tibble::lst(
            grDevices::rgb(166 / 255, 97 / 255, 26 / 255),
        ...
        "10" = tibble::lst(
            grDevices::rgb(84 / 255, 48 / 255, 5 / 255),
            grDevices::rgb(140 / 255, 81 / 255, 10 / 255),
            grDevices::rgb(191 / 255, 129 / 255, 45 / 255),
            grDevices::rgb(223 / 255, 194 / 255, 125 / 255),
            grDevices::rgb(246 / 255, 232 / 255, 195 / 255),
    ...
    "PuOr" = tibble::lst(
        ...
        "4" = tibble::lst(
            grDevices::rgb(230 / 255, 97 / 255, 1 / 255),
        ...
        "10" = tibble::lst(
            grDevices::rgb(127 / 255, 59 / 255, 8 / 255),
            grDevices::rgb(179 / 255, 88 / 255, 6 / 255),
            grDevices::rgb(224 / 255, 130 / 255, 20 / 255),
            grDevices::rgb(253 / 255, 184 / 255, 99 / 255),
            grDevices::rgb(254 / 255, 224 / 255, 182 / 255),
    ...
    "Accent" = tibble::lst(
        ...
        "2" = tibble::lst(
            grDevices::rgb(127 / 255, 201 / 255, 127 / 255),
    ...
    "Set1" = tibble::lst(
        ...
        "2" = tibble::lst(
            grDevices::rgb(228 / 255, 26 / 255, 28 / 255),
    ...
    "Set3" = tibble::lst(
        ...
        "2" = tibble::lst(
            grDevices::rgb(141 / 255, 211 / 255, 199 / 255),
    ...
    "Dark2" = tibble::lst(
        ...
        "2" = tibble::lst(
            grDevices::rgb(27 / 255, 158 / 255, 119 / 255),
    ...
    "Paired" = tibble::lst(
        ...
        "2" = tibble::lst(
            grDevices::rgb(166 / 255, 206 / 255, 227 / 255),
    ...
    "Pastel2" = tibble::lst(
        ...
        "2" = tibble::lst(
            grDevices::rgb(179 / 255, 226 / 255, 205 / 255),
    ...
    "Pastel1" = tibble::lst(
        ...
        "2" = tibble::lst(
            grDevices::rgb(251 / 255, 180 / 255, 174 / 255),
            grDevices::rgb(204 / 255, 235 / 255, 197 / 255)
        ),
        "3" = tibble::lst(
            grDevices::rgb(251 / 255, 180 / 255, 174 / 255),
    ...
    "OrRd" = tibble::lst(
        ...
        "4" = tibble::lst(
            grDevices::rgb(254 / 255, 240 / 255, 217 / 255),
        ...
        "8" = tibble::lst(
            grDevices::rgb(255 / 255, 247 / 255, 236 / 255),
            grDevices::rgb(254 / 255, 232 / 255, 200 / 255),
            grDevices::rgb(253 / 255, 212 / 255, 158 / 255),
            grDevices::rgb(253 / 255, 187 / 255, 132 / 255),
            grDevices::rgb(252 / 255, 141 / 255, 89 / 255),
        ...
        "10" = tibble::lst(
            grDevices::rgb(255 / 255, 247 / 255, 235 / 255),
    ...
    "PuBu" = tibble::lst(
        ...
        "4" = tibble::lst(
            grDevices::rgb(241 / 255, 238 / 255, 246 / 255),
        ...
        "8" = tibble::lst(
            grDevices::rgb(255 / 255, 247 / 255, 251 / 255),
            grDevices::rgb(236 / 255, 231 / 255, 242 / 255),
            grDevices::rgb(208 / 255, 209 / 255, 230 / 255),
            grDevices::rgb(166 / 255, 189 / 255, 219 / 255),
            grDevices::rgb(116 / 255, 169 / 255, 207 / 255),
        ...
        "10" = tibble::lst(
            grDevices::rgb(255 / 255, 247 / 255, 250 / 255),
    ...
    "BuPu" = tibble::lst(
        ...
        "4" = tibble::lst(
            grDevices::rgb(237 / 255, 248 / 255, 251 / 255),
            grDevices::rgb(179 / 255, 205 / 255, 227 / 255),
        ...
        "8" = tibble::lst(
            grDevices::rgb(247 / 255, 252 / 255, 253 / 255),
            grDevices::rgb(224 / 255, 236 / 255, 244 / 255),
            grDevices::rgb(191 / 255, 211 / 255, 230 / 255),
            grDevices::rgb(158 / 255, 188 / 255, 218 / 255),
            grDevices::rgb(140 / 255, 150 / 255, 198 / 255),
    ...
    "Oranges" = tibble::lst(
        ...
        "4" = tibble::lst(
            grDevices::rgb(254 / 255, 237 / 255, 222 / 255),
        ...
        "8" = tibble::lst(
            grDevices::rgb(255 / 255, 245 / 255, 235 / 255),
            grDevices::rgb(254 / 255, 230 / 255, 206 / 255),
            grDevices::rgb(253 / 255, 208 / 255, 162 / 255),
            grDevices::rgb(253 / 255, 174 / 255, 107 / 255),
            grDevices::rgb(253 / 255, 141 / 255, 60 / 255),
        ...
        "10" = tibble::lst(
            grDevices::rgb(255 / 255, 244 / 255, 235 / 255),
    ...
    "YlOrBr" = tibble::lst(
        ...
        "4" = tibble::lst(
            grDevices::rgb(255 / 255, 255 / 255, 212 / 255),
        ...
        "8" = tibble::lst(
            grDevices::rgb(255 / 255, 255 / 255, 229 / 255),
            grDevices::rgb(255 / 255, 247 / 255, 188 / 255),
            grDevices::rgb(254 / 255, 227 / 255, 145 / 255),
            grDevices::rgb(254 / 255, 196 / 255, 79 / 255),
            grDevices::rgb(254 / 255, 153 / 255, 41 / 255),
    ...
    "Reds" = tibble::lst(
        ...
        "8" = tibble::lst(
            grDevices::rgb(255 / 255, 245 / 255, 240 / 255),
            grDevices::rgb(254 / 255, 224 / 255, 210 / 255),
            grDevices::rgb(252 / 255, 187 / 255, 161 / 255),
            grDevices::rgb(252 / 255, 146 / 255, 114 / 255),
            grDevices::rgb(251 / 255, 106 / 255, 74 / 255),
        ...
        "10" = tibble::lst(
            grDevices::rgb(255 / 255, 244 / 255, 240 / 255),
    ...
    "RdPu" = tibble::lst(
        ...
        "8" = tibble::lst(
            grDevices::rgb(255 / 255, 247 / 255, 243 / 255),
            grDevices::rgb(253 / 255, 224 / 255, 221 / 255),
            grDevices::rgb(252 / 255, 197 / 255, 192 / 255),
            grDevices::rgb(250 / 255, 159 / 255, 181 / 255),
            grDevices::rgb(247 / 255, 104 / 255, 161 / 255),
        ...
        "10" = tibble::lst(
            grDevices::rgb(255 / 255, 247 / 255, 242 / 255),
    ...
    "Greens" = tibble::lst(
        ...
        "8" = tibble::lst(
            grDevices::rgb(247 / 255, 252 / 255, 245 / 255),
            grDevices::rgb(229 / 255, 245 / 255, 224 / 255),
            grDevices::rgb(199 / 255, 233 / 255, 192 / 255),
            grDevices::rgb(161 / 255, 217 / 255, 155 / 255),
            grDevices::rgb(116 / 255, 196 / 255, 118 / 255),
        ...
        "10" = tibble::lst(
            grDevices::rgb(247 / 255, 252 / 255, 244 / 255),
    ...
    "YlGnBu" = tibble::lst(
        ...
        "8" = tibble::lst(
            grDevices::rgb(255 / 255, 255 / 255, 217 / 255),
            grDevices::rgb(237 / 255, 248 / 255, 177 / 255),
            grDevices::rgb(199 / 255, 233 / 255, 180 / 255),
            grDevices::rgb(127 / 255, 205 / 255, 187 / 255),
            grDevices::rgb(65 / 255, 182 / 255, 196 / 255),
        ...
        "10" = tibble::lst(
            grDevices::rgb(255 / 255, 255 / 255, 216 / 255),
    ...
    "Purples" = tibble::lst(
        ...
        "8" = tibble::lst(
            grDevices::rgb(252 / 255, 251 / 255, 253 / 255),
            grDevices::rgb(239 / 255, 237 / 255, 245 / 255),
            grDevices::rgb(218 / 255, 218 / 255, 235 / 255),
            grDevices::rgb(188 / 255, 189 / 255, 220 / 255),
            grDevices::rgb(158 / 255, 154 / 255, 200 / 255),
        ...
        "10" = tibble::lst(
            grDevices::rgb(252 / 255, 250 / 255, 253 / 255),
    ...
    "GnBu" = tibble::lst(
        ...
        "4" = tibble::lst(
            grDevices::rgb(240 / 255, 249 / 255, 232 / 255),
        ...
        "8" = tibble::lst(
            grDevices::rgb(247 / 255, 252 / 255, 240 / 255),
            grDevices::rgb(224 / 255, 243 / 255, 219 / 255),
            grDevices::rgb(204 / 255, 235 / 255, 197 / 255),
            grDevices::rgb(168 / 255, 221 / 255, 181 / 255),
            grDevices::rgb(123 / 255, 204 / 255, 196 / 255),
    ...
    "YlOrRd" = tibble::lst(
        ...
        "4" = tibble::lst(
            grDevices::rgb(255 / 255, 255 / 255, 178 / 255),
    ...
    "PuRd" = tibble::lst(
        ...
        "8" = tibble::lst(
            grDevices::rgb(247 / 255, 244 / 255, 249 / 255),
            grDevices::rgb(231 / 255, 225 / 255, 239 / 255),
            grDevices::rgb(212 / 255, 185 / 255, 218 / 255),
            grDevices::rgb(201 / 255, 148 / 255, 199 / 255),
            grDevices::rgb(223 / 255, 101 / 255, 176 / 255),
        ...
        "10" = tibble::lst(
            grDevices::rgb(247 / 255, 243 / 255, 248 / 255),
    ...
    "Blues" = tibble::lst(
        ...
        "4" = tibble::lst(
            grDevices::rgb(239 / 255, 243 / 255, 255 / 255),
        ...
        "8" = tibble::lst(
            grDevices::rgb(247 / 255, 251 / 255, 255 / 255),
            grDevices::rgb(222 / 255, 235 / 255, 247 / 255),
            grDevices::rgb(198 / 255, 219 / 255, 239 / 255),
            grDevices::rgb(158 / 255, 202 / 255, 225 / 255),
            grDevices::rgb(107 / 255, 174 / 255, 214 / 255),
        ...
        "10" = tibble::lst(
            grDevices::rgb(247 / 255, 250 / 255, 255 / 255),
