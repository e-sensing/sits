...
.torch_linear_batch_norm_relu_dropout <- function() {
    torch::nn_module(
...
#'
#
.torch_linear_relu_dropout <- function() {
    torch::nn_module(
        classname = "torch_linear_batch_norm_relu_dropout",
        initialize = function(input_dim,
                              output_dim,
...
.torch_linear_batch_norm_relu <- function() {
    torch::nn_module(
        classname = "torch_linear_batch_norm_relu_dropout",
        initialize = function(input_dim,
                              output_dim) {
...
#' @return A linear tensor block.
#'
.torch_multi_linear_batch_norm_relu <- function() {
    torch::nn_module(
