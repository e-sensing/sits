#' @keywords internal
#' @export
.source_item_get_date.awsod_cube <- function(source,
                                             item, ...,
                                             collection = NULL) {
...
#' @keywords internal
#' @export
.source_item_get_hrefs.awsod_cube <- function(source,
                                              item, ...,
                                              collection = NULL) {
...
#' @keywords internal
#' @export
.source_item_get_bands.awsod_cube <- function(source,
                                              item, ...,
                                              collection = NULL) {
    names(item[["assets"]])
}
...
#' @keywords internal
#' @export
.source_item_get_resolutions.awsod_cube <- function(source,
                                                    item, ...,
                                                    collection = NULL) {
...
#' @keywords internal
#' @export
.source_items_new.awsod_cube <- function(source,
                                         collection, ...,
                                         stac_query,
                                         tiles = NULL) {

    # set caller to show in errors
    .check_set_caller(".source_items_new.awsod_cube")
...
#' @keywords internal
#' @export
.source_items_tiles_group.awsod_cube <- function(source,
                                                 items, ...,
                                                 collection = NULL) {
...
#' @keywords internal
#' @export
.source_items_tile_get_crs.awsod_cube <- function(source,
                                                  tile_items, ...,
                                                  collection = NULL) {
...
#' @keywords internal
#' @export
.source_items_tile_get_name.awsod_cube <- function(source,
                                                   tile_items, ...,
                                                   collection = NULL) {
...
#' @keywords internal
#' @export
.source_items_tile_get_bbox.awsod_cube <- function(source,
                                                   tile_items, ...,
                                                   collection = NULL) {
...
#' @keywords internal
#' @export
.source_items_tile_get_size.awsod_cube <- function(source,
                                                   tile_items, ...,
                                                   collection = NULL) {
