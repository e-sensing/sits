...
sample sizes per strata to obtain suitable values of error-adjusted
area, providing five allocation strategies.
...
A matrix with options to decide allocation of sample size to each class.
This matrix uses the same format as Table 5 of Olofsson et al.(2014).
