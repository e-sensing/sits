...
abstract: Using time series derived from big Earth Observation data sets is one of
  ...
  image time series analysis called **sits**. The package support use of 
  machine learning techniques for classification image time series obtained from data
  cubes. Methods available include linear and quadratic discrimination analysis, support
...
of image data cubes using machine learning methods. The basic workflow is:
