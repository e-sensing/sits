...
Where $a$ and $d$ consists in all agreements, and $b$ and $c$ all disagreements. The ARI can be obtained by
$$
ARI=\frac{a+d-e}{a+d+b+c-e},
$$
where $e$ is the expected agreement. An important relation captured by ARI is the key to... 

takes into consideration both the number of partitions and the total agreements between any two pairs of samples with respect to those partitions. 
