...
mato_grosso_4bands  <- sits_select_bands(samples_mt_6bands, ndvi, evi, nir, mir)
...
knitr::include_graphics(system.file("extdata/markdown", "sinop_class.png", package = "sits"))
```
