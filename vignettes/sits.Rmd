...
`sits` implements a raster classification scheme based on raster cubes where images are stacked to form the third dimension. Our tested approach is `TIFF` cubes, where the temporal dimension is stored in the image bands. The classification task is realized in pararel.
