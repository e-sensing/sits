...
mato_grosso_2bands  <- sits_select_bands(samples_mt_6bands, ndvi, evi)
...
```{r, fig.align="center", fig.cap="Patterns for the Mato Grosso 2 band data set"}
# Select a subset of the samples to be plotted
mato_grosso_2bands %>% 
    sits_patterns() %>% 
    sits_plot()
...
```{r, fig.align="center", fig.cap="Structure of fullCNN architecture (source: Wang et al.(2017))"}

knitr::include_graphics(system.file("extdata/markdown", "fullcnn.png", package = "sits"))
```
...
```{r, fig.align="center", fig.cap="Structure of ResNet architecture (source: Wang et al.(2017))"}

knitr::include_graphics(system.file("extdata/markdown", "resnet.png", package = "sits"))
```
...
```{r, fig.align="center", fig.cap="Structure of tempCNN architecture (source: Pelletier et al.(2019))"}

knitr::include_graphics(system.file("extdata/markdown", "tempcnn.png", package = "sits"))
```
