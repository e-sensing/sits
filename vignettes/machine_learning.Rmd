...
mato_grosso_2bands  <- sits_select_bands(samples_mt_4bands, ndvi, evi)
mato_grosso_2bands %>% 
...
```{r, echo = FALSE, fig.align="center", fig.height=5, fig.width=8,  fig.cap="Forest samples in Mato Grosso for the NDVI band"}
knitr::include_graphics(system.file("extdata/markdown/figures", "forest_ndvi.png", package = "sits"))
```
...
```{r, echo = FALSE, fig.align="center", fig.height=5, fig.width=8, fig.cap="Patterns of samples for land use/land cover classes in Mato Grosso"}
knitr::include_graphics(system.file("extdata/markdown/figures", "patterns_mt.png", package = "sits"))
```
...
rfor_model <- sits_train(samples_mt_4bands, sits_rfor(num_trees = 500))
...
class.tb <- point_mt_4bands %>% 
    ...
    plot(bands = c("ndvi", "mir"))
```

```{r, echo = FALSE, fig.align="center", fig.height=5, fig.width=8, fig.cap="Patterns of samples for land use/land cover classes in Mato Grosso"}
knitr::include_graphics(system.file("extdata/markdown/figures", "point_mt_classified_rfor.png", package = "sits"))
```
...
```{r, echo = FALSE, fig.align="center", fig.height=3, fig.width=5, fig.cap="Temporal clasification of a time series of 16 years using a Random Forest model"}
knitr::include_graphics(system.file("extdata/markdown/figures", "point_classification.png", package = "sits"))
```
...
svm_model <- sits_train(mato_grosso_2bands, 
...
```{r, echo = FALSE, fig.align="center", fig.cap="Temporal clasification of a time series of 16 years using an SVM model"}
knitr::include_graphics(system.file("extdata/markdown/figures", "point_mt_classified_svm.png", package = "sits"))
```
...
mlp_model <- sits_train(mato_grosso_2bands, sits_deeplearning(
...
```{r, echo = FALSE, fig.align="center", fig.height=5, fig.width=8, fig.cap="Training history of multi-layer percepton model."}
knitr::include_graphics(system.file("extdata/markdown/figures", "mlp_model.png", package = "sits"))
```
...
```{r, echo = FALSE, fig.align="center", fig.cap="Structure of fullCNN architecture (source: Wang et al.(2017))"}

knitr::include_graphics(system.file("extdata/markdown/figures", "fullcnn.png", package = "sits"))
```
...
```{r, echo = FALSE, fig.align="center", fig.height=5, fig.width=8, fig.cap="Training history of 1D-CNN model"}
knitr::include_graphics(system.file("extdata/markdown/figures", "cnn_model.png", package = "sits"))
```
...
```{r, echo = FALSE, fig.align="center", fig.cap="Structure of ResNet architecture (source: Wang et al.(2017))"}

knitr::include_graphics(system.file("extdata/markdown/figures", "resnet.png", package = "sits"))
```
...
```{r, echo = FALSE, fig.align="center", fig.height=5, fig.width=8, fig.cap="Training history of ResNet model"}
knitr::include_graphics(system.file("extdata/markdown/figures", "resnet.png", package = "sits"))
```
...
```{r, echo = FALSE, fig.align="center", fig.cap="Structure of tempCNN architecture (source: Pelletier et al.(2019))"}

knitr::include_graphics(system.file("extdata/markdown/figures", "tempcnn.png", package = "sits"))
```
...
```{r, echo = FALSE, fig.align="center", fig.height=5, fig.width=8, fig.cap="Training history of TempCNN model"}
knitr::include_graphics(system.file("extdata/markdown/figures", "tcnn_model.png", package = "sits"))
```
...
```{r, echo = FALSE, fig.align="center", fig.height=3.4, fig.width=5.5, fig.cap= "LSTM Fully Convolutional Networks for Time Series Classification (source: Karim et al.(2019))"}

knitr::include_graphics(system.file("extdata/markdown/figures", "lstm-cnn.png", package = "sits"))
```
...
```{r, eval = FALSE}
lstm_fcn_model <- sits_train(mato_grosso_2bands, 
                       sits_LSTM_FCN(
                          lstm_units          = 16,
                          lstm_dropout        = 0.80,
...
```{r, echo = FALSE, fig.align="center", fig.height=5, fig.width=8, fig.cap="Training history of TempCNN model"}
knitr::include_graphics(system.file("extdata/markdown/figures", "lstm_fcn_model.png", package = "sits"))
```
