...
```{r, fig.align="center", fig.height=3.4, fig.width=5.5, fig.cap="1D-CNN classification of a $16$ year time series."}
# classify and plot 
class.tb <- point_mt_2bands %>% 
    sits_whittaker(lambda = 0.2, bands_suffix = "") %>% 
...
```{r, fig.align="center", fig.height=3.4, fig.width=5.5, fig.cap="Classification of a $16$ year time series using ResNet model."}
# classify and plot 
class.tb <- point_mt_2bands %>% 
    sits_whittaker(lambda = 0.2, bands_suffix = "") %>% 
