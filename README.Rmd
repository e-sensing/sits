...
```{r, echo = FALSE}
knitr::include_graphics(system.file("extdata/markdown/figures", "samples_mt_4bands.png", package = "sits"))
```
...
```{r, echo = FALSE, fig.align="center", fig.height=5, fig.width=8, fig.cap= "Samples for NDVI band for Cerrado class"}
knitr::include_graphics(system.file("extdata/markdown/figures", "samples_cerrado.png", package = "sits"))
```
...
```{r, echo = FALSE, fig.align="center", fig.height=5, fig.width=8, fig.cap = "Dendrogram for samples of classes Pasture and Cerrado"}
knitr::include_graphics(system.file("extdata/markdown/figures", "cluster_dendro.png", package = "sits"))
```
...
```{r, echo = FALSE, fig.align="center", fig.height=5, fig.width=8, fig.cap="Whittaker smoother filter applied on one-year NDVI time series. The example uses default $\\lambda=1$ parameter."}
knitr::include_graphics(system.file("extdata/markdown/figures", "whit.png", package = "sits"))
```
...
```{r, echo = FALSE, fig.align="center", fig.height=5, fig.width=8, fig.cap="XGBoost classification of a $16$ years time series"}
...
```{r, echo = FALSE, fig.align="center", fig.cap="Image classified with XGBoost"}
