...
For details in gdalcubes, please see Reference [4] and  [https://github.com/appelmar/gdalcubes](https://github.com/appelmar/gdalcubes).
...
-   DL with 1D convolutional neural networks (`sits_FCN`) (see reference [6])
-   DL combining 1D CNN and multi-layer perceptron networks
    (`sits_TempCNN`) (See reference [7])
-   DL using Deep Residual Networks (`sits_ResNet`) (see reference [6])
-   DL using a combination of long-short term memory (LSTM) 
    and 1D convolutional neural networks (`sits_LSTM_FCN`) (See reference [5])
...
- [6] Hassan Fawaz, Germain Forestier, Jonathan Weber, Lhassane Idoumghar,  and Pierre-Alain Muller, "Deep learning for time series classification: a review". Data Mining and Knowledge Discovery, 33(4): 917--963, 2019.

- [7] Pelletier, Charlotte, Geoffrey I. Webb, and Francois Petitjean. “Temporal Convolutional Neural Network for the Classification of Satellite Image Time Series.” Remote Sensing 11 (5), 2019. 

- [8] Wehrens, Ron and Kruisselbrink, Johannes. "Flexible Self-Organising Maps in kohonen 3.0". Journal of Statistical Software, 87, 7 (2018).
