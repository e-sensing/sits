...
[![Codecov test coverage](https://codecov.io/gh/e-sensing/sits/branch/master/graph/badge.svg)](https://app.codecov.io/gh/e-sensing/sits?branch=master)
<!-- badges: end -->
...
```{r, eval = TRUE, echo = TRUE, fig.align="center", fig.height=2.7, fig.width=7, fig.cap="Plot of point at location (-55.65931, -11.76267) labelled as Pasture", cache = TRUE} 
plot(points[1,])
```
...
```{r, fig.align="center", fig.height=3.5, fig.width=7, fig.cap="Samples for NDVI band for Cerrado class", cache=TRUE}
...
```{r, fig.align="center", fig.height=3.5, fig.width=7, fig.cap="Samples analysis using SOM (grid 6x6)", cache=TRUE}
...
```{r, fig.align="center", fig.height=3.5, fig.width=7, fig.cap="Whittaker filter of NDVI time series", cache=TRUE}
...
```{r, fig.align="center", fig.height=3.5, fig.width=7, fig.cap="Classification of NDVI time series using TempCNN", cache=TRUE}
# training data set
...
```{r, fig.align="center", fig.height=4.5, fig.width=9, fig.cap="Land use and Land cover in Sinop, MT, Brazil in 2018", cache=TRUE}
