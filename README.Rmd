...
knitr::include_graphics("inst/extdata/markdown/figures/sits_general_view.png")
```
...
knitr::include_graphics("inst/extdata/markdown/figures/datacube_conception.png")
```

The image collections accessible in `sits` version 0.15.1 to build EO data cubes are:
