...
using AWS. Users need to provide AWS credentials using environment variables.
...
```{r, eval=FALSE, fig.height=2.7, fig.width=5}
...
```{r, echo=FALSE, fig.align="center", fig.cap="Samples for NDVI band for Cerrado class"}
...
```{r, fig.align="center", fig.height=3, fig.width=6, fig.cap="Time series classification using SVM"}
