...
test_that("Reading a point from SATVEG ", {
    ...
    expect_equal(sum(point_terra.tb$time_series[[1]]$evi), 158.11, tolerance = 1e-3)
    ...
    expect_equal(sum(point_aqua.tb$time_series[[1]]$evi), 132.2078, tolerance = 1e-3)
    ...
    expect_equal(sum(point_comb.tb$time_series[[1]]$evi), 289.9574, tolerance = 1e-3)
