...
test_that("One-year, multicores mosaic", {
    ...
    expect_equal(mosaic_cube2[["tile"]], "MOSAIC")
    expect_equal(nrow(mosaic_cube2), 1)
    bbox_cube <- sits_bbox(mosaic_cube2)
    ...
    unlink(mosaic_cube2$file_info[[1]]$path)
})
