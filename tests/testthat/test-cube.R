...
test_that("Automatic test cube creation", {
    testthat::skip_on_cran()

    # cb4_mux_20 <- sits_cube(
    #     source = "BDC",
    #     collection = "CB4MUX_20-1",
    #     name = "cbers_022024",
    #     tiles = "043045",
    #     bands = c("NDVI", "EVI", "CMASK"),
    ...
    # )
    #
    # cb4_20_1m_stk <- sits_cube(
    #     source = "BDC",
    #     collection = "CB4_20_1M_STK-1",
    #     name = "cbers",
    #     tiles = "043045",
    #     bands = c("NDVI", "EVI", "MASK"),
    #     start_date = "2019-01-01",
    #     end_date = "2019-08-28"
    # )
    #
    ...
    #     collection = "LC8_30-1",
    #     name = "l8",
    #     bands = c("NDVI", "EVI", "Fmask4"),
    #     tiles = c("048045"),
    #     start_date = "2019-01-01",
    #     end_date = "2019-01-31"
    # )
    #
    # l8_30_16d_stk_1 <- sits_cube(
    #     source = "BDC",
