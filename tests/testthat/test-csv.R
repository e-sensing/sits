...
test_that("Data to CSV",{
    expect_true(sits_data_toCSV(cerrado_2classes, file = "./cerrado_2classes.csv"))
})
...
test_that("Data to shp",{
    ...
    result <- sits_shp_toCSV(shpfile, csvfile, label, timeline_2000_2017, start_date, end_date)
