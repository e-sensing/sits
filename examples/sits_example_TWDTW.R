...
sits_configWTSS (URL = "http://www.dpi.inpe.br/tws/wtss", coverage = "mod13q1_512", bands = c("ndvi", "evi", "blue", "red", "nir", "mir"))
...
embrapa.tb <- sits_fromCSV ("./data/Samples/damien.csv", n_max = 30)
