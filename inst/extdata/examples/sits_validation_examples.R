...
clu.tb <- sits_cluster(cerrado.tb[1:20,], method = "centroids", bands = c("ndvi", "evi"), n_clusters = 2)
...
cm <- sits_validate (cerrado1.tb, method = "centroids", bands = c("ndvi","evi", "nir"), n_clusters = 2, times = 10, perc = 0.1)
