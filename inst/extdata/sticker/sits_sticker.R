...
image <- "/users/gilbertocamara/sits/inst/extdata/sticker/sits.png"
...
hexSticker::sticker(image, package="sits", p_size=12,
                    s_x=1, s_y=.75, s_width = 0.5, s_height = 0.5,
                    p_family = "rob", h_color = "sienna4", h_fill = "sienna3", dpi = 1200,
        filename="/users/gilbertocamara/sits/inst/extdata/sticker/sits_sticker.png")
